...
public class XKWebView extends WebView {
    ...
    public XKWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(attrs);
    }

    public XKWebView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void setupWebSettings(TypedArray args) {
        boolean allowContentAccess = args.getBoolean(R.styleable.wv_allow_content_access, true);
        boolean allowFileAccess = args.getBoolean(R.styleable.wv_allow_file_access, true);
        boolean allowFileAccessFromFileURLs = args.getBoolean(R.styleable.wv_allow_file_access_from_file_urls, true);
        boolean allowUniversalAccessFromFileURLs = args.getBoolean(R.styleable.wv_allow_universal_access_from_file_urls, false);
        boolean appCacheEnabled = args.getBoolean(R.styleable.wv_app_cache_enabled, false);
        boolean blockNetworkImage = args.getBoolean(R.styleable.wv_block_network_image, false);
        boolean blockBlockNetworkLoads = args.getBoolean(R.styleable.wv_block_network_loads, false);
        boolean builtInZoomControls = args.getBoolean(R.styleable.wv_built_in_zoom_controls, false);
        int cacheMode = args.getInt(R.styleable.wv_cache_mode, WebSettings.LOAD_DEFAULT);
        boolean databaseEnabled = args.getBoolean(R.styleable.wv_database_enabled, false);
        boolean displayZoomControls = args.getBoolean(R.styleable.wv_display_zoom_controls, false);
        boolean domStorageEnabled = args.getBoolean(R.styleable.wv_dom_storage_enabled, false);
        boolean geolocationEnabled = args.getBoolean(R.styleable.wv_geolocation_enabled, true);
        boolean javaScriptCanOpenWindowsAutomatically = args.getBoolean(R.styleable.wv_java_script_can_open_windows_automatically, false);
        boolean jsEnabled = args.getBoolean(R.styleable.wv_java_script_enabled, false);
        boolean loadWithOverviewMode = args.getBoolean(R.styleable.wv_load_with_overview_mode, false);
        boolean loadsImagesAutomatically = args.getBoolean(R.styleable.wv_loads_images_automatically, true);
        boolean needInitialFocus = args.getBoolean(R.styleable.wv_need_initial_focus, false);
        boolean saveFormEnabled = args.getBoolean(R.styleable.wv_save_form_data, true);
        boolean supportMultipleWindows = args.getBoolean(R.styleable.wv_support_multiple_windows, false);
        boolean supportZoom = args.getBoolean(R.styleable.wv_support_zoom, true);
        boolean useWideViewPort = args.getBoolean(R.styleable.wv_use_wide_view_port, true);
