 ...
 */
public class AtmineDataSource implements IAsyncDataSource<List<PushMessage>> {
    private static final int DEFAULT_PER_PAGE = 20;
    private static final int DEFAULT_PUSHTYPE = 1;
    private static final int DEFAULT_READTYPE = -1;
    private int mPage;
    private int mMaxPage = 0;
    private int mPerPage = DEFAULT_PER_PAGE;
    private int mPushtype = 1 ;
    private int mPushtype1 = 2;
    private int mPushtype2 = 21;
    private int mPushtype3 = 22;
    private int mReadtype = DEFAULT_READTYPE;
    private String mCurrentAccount;

    public AtmineDataSource(String mAccount) {
    ...
    private RequestHandle loadMessageData(final ResponseSender<List<PushMessage>> sender, final int page) throws Exception {
        ...
        String sPushType = Security.aesEncrypt(String.format("%s,%s,%s,%s", mPushtype, mPushtype1 ,mPushtype2 ,mPushtype3));//消息类型
