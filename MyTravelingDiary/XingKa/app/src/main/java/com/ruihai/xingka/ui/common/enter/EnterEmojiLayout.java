...
public class EnterEmojiLayout extends EnterLayout {
    ...
    private View.OnClickListener checkBoxEmojiOnClicked = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (checkBoxEmoji.isChecked()) {
                ...
                final int bottomHigh = AppUtility.dip2px(100); // 底部虚拟按键高度，nexus5是73dp，以防万一，所以设大一点
    ...
    public EnterEmojiLayout(final FragmentActivity activity, View.OnTouchListener sendTextOnClick, Type type, EmojiType emojiType) {
                ...
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        if (mEnterLayoutAnimSupportContainer != null && mEnterLayoutAnimSupportContainer.softkeyboardOpenY == 0) {
                            //获取输入法软键盘的高度
                            softkeyboardHeight = contentViewHeight - getContentViewHeight(activity);
    ...
    public EnterEmojiLayout(FragmentActivity activity, View.OnTouchListener sendTextOnClick) {
...
//        dropTempWindow();
    ...
    public void animEnterLayoutStatusChanaged(boolean isOpen) {
        ...
        if (!isOpen) {
            ViewHelper.setTranslationY(emojiKeyboardLayout, AppUtility.dip2px(0));
            ViewHelper.setTranslationY(voiceLayout, 0);
        }
    }
