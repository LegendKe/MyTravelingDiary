...
public class PraiseDataSourse implements IAsyncDataSource<List<PraiseInfo>> {
    ...
    public PraiseDataSourse(String account, String userAccount) {
    ...
    private RequestHandle loadCaptions(final ResponseSender<List<PraiseInfo>> sender, final int page) throws Exception {
        ...
        Call<PraiseListRepo> call = ApiModule.apiService_1().myPhotoTopicPraiseListPage(sAccount, sUserAccount, sPage, sPerPage);
