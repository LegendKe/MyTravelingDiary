...
public class PraiseListDataSource implements IAsyncDataSource<List<PraiseItem>> {
    ...
    private String mGuid;//图说ID

    public PraiseListDataSource(String account, String userAccount, String gUid) {
    ...
    private RequestHandle loadCaptions(final ResponseSender<List<PraiseItem>> sender, final int page) throws Exception {
        ...
        Call<PraiseRepo> call = ApiModule.apiService_1().photoTopicPraiseListPage(sAccount, sGUid, sUserAccount, sPage, sPerPage);
