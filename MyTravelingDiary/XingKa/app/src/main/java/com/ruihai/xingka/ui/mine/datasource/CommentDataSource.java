 ...
 */
public class CommentDataSource implements IAsyncDataSource<List<PushMessage>> {
    ...
    private int mPushtype1 = 4;
    private int mPushtype2 = 23;
    private int mPushtype3 = 24;
    private int mReadtype = DEFAULT_READTYPE;
    private String mCurrentAccount;

    public CommentDataSource(String mAccount) {
