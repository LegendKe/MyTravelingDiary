...
public class RegisterPhoneNumActivity extends UmengActivity {
    ...
    public static void launch(Context from) {
        Intent intent = new Intent(from, RegisterPhoneNumActivity.class);
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        ...
                        if (result == SMSSDK.RESULT_COMPLETE) {
                            ...
                            //ProgressHUD.showInfoMessage(mContext,"每分钟请求次数超过限制");
                            Log.e("判断", "222");
                            if (event == SMSSDK.EVENT_GET_VERIFICATION_CODE
                                    && data != null
...
//            dialog(getString(R.string.register_please_input_right_phone));
    ...
    private void afterVerificationCodeRequested() {
        ...
        RegisterVerifyActivity.launch(RegisterPhoneNumActivity.this, phone, countryNumber);
    }
