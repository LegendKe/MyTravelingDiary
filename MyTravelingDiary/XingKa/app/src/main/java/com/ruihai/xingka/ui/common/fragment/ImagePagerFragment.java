...
import com.ruihai.xingka.ui.common.adapter.ImagePagerAdapter;
import com.ruihai.xingka.widget.MultiTouchViewPager;
...
public class ImagePagerFragment extends Fragment {
    ...
    public final static String ARG_USER_NICK = "USER_NICK";
    ...
    public void setPhotos(List<String> paths, int currentItem, String userNick) {
        this.paths.clear();
        this.paths.addAll(paths);
        this.currentItem = currentItem;
        mPagerAdapter = new ImagePagerAdapter(getActivity(), this.paths, userNick);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPagerAdapter = new ImagePagerAdapter(getActivity(), paths, userNick);
        mViewPager.setAdapter(mPagerAdapter);
        mViewPager.setCurrentItem(currentItem);
