...
public class ProgressLayout extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        loadingStateProgressBarWidth =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_progressLoadingStateProgressBarWidth, 108);

        loadingStateProgressBarHeight =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_progressLoadingStateProgressBarHeight, 108);
        ...
        emptyStateImageWidth =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_progressEmptyStateImageWidth, 308);

        emptyStateImageHeight =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_progressEmptyStateImageHeight, 308);

        emptyStateTitleTextSize =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_progressEmptyStateTitleTextSize, 15);

        emptyStateContentTextSize =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_progressEmptyStateContentTextSize, 14);

        emptyStateTitleTextColor =
                typedArray.getColor(R.styleable.ProgressLayout_progressEmptyStateTitleTextColor, Color.BLACK);

        emptyStateContentTextColor =
                typedArray.getColor(R.styleable.ProgressLayout_progressEmptyStateContentTextColor, Color.BLACK);
        ...
        errorStateImageWidth =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_progressErrorStateImageWidth, 308);

        errorStateImageHeight =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_progressErrorStateImageHeight, 308);

        errorStateTitleTextSize =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_progressErrorStateTitleTextSize, 15);

        errorStateContentTextSize =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_progressErrorStateContentTextSize, 14);

        errorStateTitleTextColor =
                typedArray.getColor(R.styleable.ProgressLayout_progressErrorStateTitleTextColor, Color.BLACK);

        errorStateContentTextColor =
                typedArray.getColor(R.styleable.ProgressLayout_progressErrorStateContentTextColor, Color.BLACK);

        errorStateButtonTextColor =
                typedArray.getColor(R.styleable.ProgressLayout_progressErrorStateButtonTextColor, Color.BLACK);
